...
///
/// ```rust
/// use rug::rational::{BorrowRational, StackRational};
/// use rug::Rational;
/// let r = Rational::from((42, 3));
/// let neg: BorrowRational = r.as_neg();
/// // r is still valid
/// assert_eq!(r, StackRational::from((42, 3)));
/// assert_eq!(*neg, StackRational::from((-42, 3)));
/// ```
#[derive(Clone, Copy)]
#[repr(transparent)]
...
impl<'a> BorrowRational<'a> {
    ...
    /// assert_eq!(*using_trait, StackRational::from((-7, 5)));

...
mod tests {
    ...
    fn check_floats() {
        ...
        assert_eq!((-1.75f32).az::<Rational>(), StackRational::from((-7, 4)));
        assert_eq!((-1f32).az::<Rational>(), -1);
        assert_eq!((-0.125f32).az::<Rational>(), StackRational::from((-1, 8)));
        assert_eq!(
        ...
        assert_eq!((-1.75f64).az::<Rational>(), StackRational::from((-7, 4)));
        assert_eq!((-1f64).az::<Rational>(), -1);
        assert_eq!((-0.125f64).az::<Rational>(), StackRational::from((-1, 8)));
        assert_eq!(
